...
(104, 2, '3523452345235', 'josejosejose', 'josejosejose', 3, 1, 4),
(105, 2, '454534523', 'qqqqqqqqqq', 'ggggggggggggg', 4, 1, 2),
(107, 1, '54656546', 'josejosejose', 'juliolujio', 5, 2, 4),
(108, 1, '23452345', 'josejosejose', 'josejosejose', 6, 4, 46),
(109, 2, '111111111', 'ggggggggggggggggg', 'gggggggggggggggggggggg', 5, 18, 18),
(110, 2, '1111111111', 'GGGG', 'GGGGG', 6, 14, 26);
...
INSERT INTO `fechas` (`id`, `fechaInicial`, `fechaFinal`, `valor`) VALUES
(1, '2022-06-16', '2022-06-30', 1),
(2, '2022-06-01', '2022-06-30', 2);
...
INSERT INTO `staffing` (`id`, `id_empleado`, `id_proyecto`, `id_fecha`) VALUES
(10, 8, 2, 1),
(11, 4, 1, NULL);
...
ALTER TABLE `empleados`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_empleados_gerencias1_idx` (`gerencias_id`),
  ADD KEY `fk_empleados_departamentos1_idx` (`departamentos_id`),
  ADD KEY `fk_empleados_cargos1_idx` (`cargos_id`),
...
ALTER TABLE `empleados`
  ...
  ADD CONSTRAINT `fk_empleados_cargos1` FOREIGN KEY (`cargos_id`) REFERENCES `cargos` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_empleados_departamentos1` FOREIGN KEY (`departamentos_id`) REFERENCES `departamentos` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_empleados_gerencias1` FOREIGN KEY (`gerencias_id`) REFERENCES `gerencias` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE `proyectos`
  ...
  ADD CONSTRAINT `fk_proyectos_empleados1` FOREIGN KEY (`empleados_id`) REFERENCES `empleados` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE `staffing`
  ...
  ADD CONSTRAINT `fk_fechas_id` FOREIGN KEY (`id_fecha`) REFERENCES `fechas` (`id`),
