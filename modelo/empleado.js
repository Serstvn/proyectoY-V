module.exports = {
    ...
    actualizar:function(conn, datos,funcion) {
        conn.query("UPDATE `empleados` SET codigo=?, ceco_id=?, cliente=?, nomCorto=?, empleados_id=? WHERE id=?",[datos.tipoDocumento, datos.documento, datos.nombre, datos.apellido, datos.gerencia,datos.departamento,datos.cargo,datos.salario],funcion);
     }
